...
In his country, it's usual to tip 15% if the bill value is between 50• and 300f If the value is different, the tip is 20%.
...
by 20/100 = 0.2
HINT: Value X is between 50 and 300, if it's >= 50 &&
<= 300
GOOD LUCK
*/
...
console.log(`The bill was ${value}, the tip was ${tip}, and the total value ${tip+value}`);
...
let i = 1;
for(const name of game.scored) console.log(`Goal ${i++} : ${name}`);
function avgF(odds){
    let sum = 0;
...
console.log(avgF(Object.values(game.odds)));
...
oddP(Object.entries(game.odds));

let scorers = {};
function scorersF(scored){ 
